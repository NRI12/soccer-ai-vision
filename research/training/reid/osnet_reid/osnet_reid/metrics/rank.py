...
try:
    from osnet_reid.metrics.rank_cylib.rank_cy import evaluate_cy
    IS_CYTHON_AVAI = True
except ImportError:
...
def evaluate_py(
    distmat, q_pids, g_pids, q_camids, g_camids, max_rank, eval_metric
):
...
def evaluate_rank(
    ...
    """
    if use_cython and IS_CYTHON_AVAI and eval_metric != 'soccernetv3':
        return evaluate_py(
