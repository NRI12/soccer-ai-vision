...
def load_checkpoint(fpath):
    ...
    Examples::
        >>> from osnet_reid.utils import load_checkpoint
...
def resume_from_checkpoint(fpath, model, optimizer=None, scheduler=None):
    ...
    Examples::
        >>> from osnet_reid.utils import resume_from_checkpoint
        >>> fpath = 'log/my_model/model.pth.tar-10'
...
def open_all_layers(model):
    ...
    Examples::
        >>> from osnet_reid.utils import open_all_layers
...
def open_specified_layers(model, open_layers):
    ...
    Examples::
        >>> from osnet_reid.utils import open_specified_layers
...
def count_num_param(model):
    ...
    Examples::
        >>> from osnet_reid.utils import count_num_param
        >>> model_size = count_num_param(model)

    .. warning::
        
        This method is deprecated in favor of
        ``osnet_reid.utils.compute_model_complexity``.
    """
    warnings.warn(
...
def load_pretrained_weights(model, weight_path):
    ...
    Examples::
        >>> from osnet_reid.utils import load_pretrained_weights
