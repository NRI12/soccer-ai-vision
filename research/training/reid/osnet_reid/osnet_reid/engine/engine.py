...
from osnet_reid.losses import DeepSupervision
...
class Engine(object):
    ...
    def __init__(self, datamanager, use_gpu=True, warmup_steps=0, use_amp=False):
        ...
        self.writer = None
        self.epoch = 0
        self.scaler = torch.amp.GradScaler('cuda') if (use_amp and self.use_gpu) else None
