...
import torch
from osnet_reid.utils.torchtools import resume_from_checkpoint
...
def main(args):
    ...
    if model_name == 'vit_b_16':
        from osnet_reid.models.vit import vit_b_16 as modelclass
    elif model_name == 'deit_b_16_ls_224':
        from osnet_reid.models.deit import deit_b_16_ls as modelclass
        img_size = [224, 224]
