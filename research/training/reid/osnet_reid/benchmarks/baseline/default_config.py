...
def get_default_config():
    ...
    cfg.train.amp = False # automatic mixed precision (faster on RTX cards with Tensor Cores)
    cfg.train.cudnn_benchmark = False # cudnn autotuner — disable for full reproducibility
